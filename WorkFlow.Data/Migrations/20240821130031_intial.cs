        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUserId = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    ClearanceLevel = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InactivatedBy = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RequisitionId = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    SubCategoryId = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ApprovalId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RequisitionId = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
                    SentTo = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    SentBy = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    Action = table.Column<int>(type: "int", nullable: false),
                    Comment = table.Column<string>(type: "nvarchar(125)", maxLength: 125, nullable: true),
                    ActionDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequisitionApprovals", x => x.ApprovalId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequisitionSupplements", x => x.SupplementId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequisitionSupplements_RequisitionId",
